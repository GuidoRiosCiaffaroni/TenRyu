...
if (!function_exists('avik_setup')) :
	...
	function avik_setup()
	{
		...
		// Add support for Responsive Video
...
define('avik_url_promotion', 'https://franchiwebdesign.com/portfolio/avik/'); // Go Pro
define('franchi_design_url', 'https://franchiwebdesign.com/'); // Franchi Design
define('avik_url_documentation_theme', 'https://franchiwebdesign.com/category/documentazione-avik/'); // Documentation Theme
define('avik_url_support_theme', 'https://franchiwebdesign.com/supporto/'); // Support Theme
define('avik_review_theme', 'https://wordpress.org/support/theme/avik/reviews/'); // Review Theme   
define('avik_forum_theme', 'https://franchiwebdesign.com/community/index.php'); // Forum Theme  
define('avik_bubiblock_slider', 'https://wordpress.org/plugins/bubiblock-slider/'); // BubiBlock Slider
define('avik_doc_menu', 'https://franchiwebdesign.com/aggiungere-id-sezioni-nel-menu/'); // Documentation Menu
