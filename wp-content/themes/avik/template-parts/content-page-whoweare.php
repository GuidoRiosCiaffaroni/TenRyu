 ...
 * @package   Avik
 */
$avik_image_who_two_page = get_theme_mod('avik_second_img_who_page');
?>
  ...
  <div class="header-image-whoweare">
    ...
    while ($avik_mod->have_posts()) : $avik_mod->the_post(); { ?>
        ...
        <img class="img-whoweare-header" src="<?php if ($avik_image_attributes[0]) :
                                              ...
                                              else : echo esc_url(get_template_directory_uri()) . '/img/whoweare.jpg';
                                              endif; ?>" />
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="image-thumbnail-portfolio">
        <div class="row">
          <div class="<?php if (false == esc_html(get_theme_mod('avik_enable_sec_imgpage_whoweare', false))) : ?>col-sm-6 <?php endif; ?> <?php if (true == esc_html(get_theme_mod('avik_enable_sec_imgpage_whoweare', true))) : ?> col-sm-12<?php endif; ?>">
            <div><?php the_content(); ?></div>
          </div>
          <?php if (false == esc_html(get_theme_mod('avik_enable_sec_imgpage_whoweare', true))) : ?>
            <div class="col-sm-6 ">
              <!-- Image 2 who we are -->
              <div class="second-image-who-we-are-page image-enter-whoweare" data-aos="zoom-in">
                <img src="<?php echo esc_url($avik_image_who_two_page); ?>" />
              </div>
            </div>
          <?php endif; ?>
        </div>
            ...
            while ($avik_new_query->have_posts()) : $avik_new_query->the_post(); ?>
              ...
              <a href="<?php the_permalink(); ?>" class="col-lg-4 col-md-4 col-sm-6 col-xs-12 link-blog" data-aos="fade-up">
                <img src="<?php if ($avik_image_attributes[0]) :
                            echo esc_url($avik_image_attributes[0]);
                          else : echo esc_url(get_template_directory_uri()) . '/images/avik-default.jpg';
                          endif; ?>">
